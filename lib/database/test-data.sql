-- Test Attorney Data for Attorney Directory
...
-- For testing, we'll insert directly into profiles and attorneys tables

-- Insert test profiles (these would normally be created via Supabase Auth)
INSERT INTO public.profiles (id, email, full_name, avatar_url, role, created_at, updated_at) VALUES
('11111111-1111-1111-1111-111111111111', 'john.smith@lawfirm.com', 'John Smith', 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('22222222-2222-2222-2222-222222222222', 'sarah.johnson@legal.com', 'Sarah Johnson', 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('33333333-3333-3333-3333-333333333333', 'michael.davis@attorney.com', 'Michael Davis', 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('44444444-4444-4444-4444-444444444444', 'emily.wilson@law.com', 'Emily Wilson', 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('55555555-5555-5555-5555-555555555555', 'robert.brown@legal.com', 'Robert Brown', 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('66666666-6666-6666-6666-666666666666', 'jennifer.garcia@lawfirm.com', 'Jennifer Garcia', 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('77777777-7777-7777-7777-777777777777', 'david.miller@attorney.com', 'David Miller', 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('88888888-8888-8888-8888-888888888888', 'lisa.anderson@legal.com', 'Lisa Anderson', 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('99999999-9999-9999-9999-999999999999', 'james.taylor@law.com', 'James Taylor', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW()),
('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'amanda.thomas@lawfirm.com', 'Amanda Thomas', 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=150&h=150&fit=crop&crop=face', 'attorney', NOW(), NOW());

-- Insert test attorneys with realistic data for North Carolina area (28034)
INSERT INTO public.attorneys (
  id, user_id, first_name, last_name, firm_name, bio, experience_years, 
...
('att001-0000-0000-0000-000000000001', '11111111-1111-1111-1111-111111111111', 'John', 'Smith', 'Smith & Associates Law Firm', 
...
('att002-0000-0000-0000-000000000002', '22222222-2222-2222-2222-222222222222', 'Sarah', 'Johnson', 'Johnson Family Law Group', 
...
('att003-0000-0000-0000-000000000003', '33333333-3333-3333-3333-333333333333', 'Michael', 'Davis', 'Davis Criminal Defense', 
...
('att004-0000-0000-0000-000000000004', '44444444-4444-4444-4444-444444444444', 'Emily', 'Wilson', 'Wilson Business Law', 
...
('att005-0000-0000-0000-000000000005', '55555555-5555-5555-5555-555555555555', 'Robert', 'Brown', 'Brown Real Estate Law', 
...
-- Free Tier Attorneys
('att006-0000-0000-0000-000000000006', '66666666-6666-6666-6666-666666666666', 'Jennifer', 'Garcia', 'Garcia Immigration Law', 
...
('att007-0000-0000-0000-000000000007', '77777777-7777-7777-7777-777777777777', 'David', 'Miller', 'Miller Employment Law', 
...
('att008-0000-0000-0000-000000000008', '88888888-8888-8888-8888-888888888888', 'Lisa', 'Anderson', 'Anderson Estate Planning', 
...
('att009-0000-0000-0000-000000000009', '99999999-9999-9999-9999-999999999999', 'James', 'Taylor', 'Taylor Bankruptcy Law', 
...
('att010-0000-0000-0000-000000000010', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Amanda', 'Thomas', 'Thomas DUI Defense', 
...
('att001-0000-0000-0000-000000000001', (SELECT id FROM practice_areas WHERE slug = 'personal-injury'), true, NOW()),

-- Sarah Johnson (Family Law - Primary)
('att002-0000-0000-0000-000000000002', (SELECT id FROM practice_areas WHERE slug = 'family-law'), true, NOW()),

-- Michael Davis (Criminal Defense - Primary)
('att003-0000-0000-0000-000000000003', (SELECT id FROM practice_areas WHERE slug = 'criminal-defense'), true, NOW()),

-- Emily Wilson (Business Law - Primary)
('att004-0000-0000-0000-000000000004', (SELECT id FROM practice_areas WHERE slug = 'business-law'), true, NOW()),

-- Robert Brown (Real Estate Law - Primary)
('att005-0000-0000-0000-000000000005', (SELECT id FROM practice_areas WHERE slug = 'real-estate-law'), true, NOW()),

-- Jennifer Garcia (Immigration Law - Primary)
('att006-0000-0000-0000-000000000006', (SELECT id FROM practice_areas WHERE slug = 'immigration-law'), true, NOW()),

-- David Miller (Employment Law - Primary)
('att007-0000-0000-0000-000000000007', (SELECT id FROM practice_areas WHERE slug = 'employment-law'), true, NOW()),

-- Lisa Anderson (Estate Planning - Primary)
('att008-0000-0000-0000-000000000008', (SELECT id FROM practice_areas WHERE slug = 'estate-planning'), true, NOW()),

-- James Taylor (Bankruptcy - Primary)
('att009-0000-0000-0000-000000000009', (SELECT id FROM practice_areas WHERE slug = 'bankruptcy'), true, NOW()),

-- Amanda Thomas (DUI Defense - Primary)
('att010-0000-0000-0000-000000000010', (SELECT id FROM practice_areas WHERE slug = 'dui-defense'), true, NOW());

-- Add some secondary practice areas for variety
INSERT INTO public.attorney_practice_areas (attorney_id, practice_area_id, is_primary, created_at) VALUES
-- John Smith also does Business Law
('att001-0000-0000-0000-000000000001', (SELECT id FROM practice_areas WHERE slug = 'business-law'), false, NOW()),

-- Sarah Johnson also does Estate Planning
('att002-0000-0000-0000-000000000002', (SELECT id FROM practice_areas WHERE slug = 'estate-planning'), false, NOW()),

-- Michael Davis also does DUI Defense
('att003-0000-0000-0000-000000000003', (SELECT id FROM practice_areas WHERE slug = 'dui-defense'), false, NOW()),

-- Emily Wilson also does Employment Law
('att004-0000-0000-0000-000000000004', (SELECT id FROM practice_areas WHERE slug = 'employment-law'), false, NOW()),

-- Robert Brown also does Business Law
('att005-0000-0000-0000-000000000005', (SELECT id FROM practice_areas WHERE slug = 'business-law'), false, NOW());
...
('att001-0000-0000-0000-000000000001', 'Mary Johnson', 'mary.johnson@email.com', 5, 
...
('att001-0000-0000-0000-000000000001', 'Robert Wilson', 'robert.wilson@email.com', 5, 
...
('att002-0000-0000-0000-000000000002', 'Jennifer Davis', 'jennifer.davis@email.com', 5, 
...
('att002-0000-0000-0000-000000000002', 'Michael Brown', 'michael.brown@email.com', 4, 
...
('att003-0000-0000-0000-000000000003', 'David Garcia', 'david.garcia@email.com', 5, 
...
('att004-0000-0000-0000-000000000004', 'Lisa Anderson', 'lisa.anderson@email.com', 5, 
...
('att005-0000-0000-0000-000000000005', 'James Taylor', 'james.taylor@email.com', 4, 
...
('att006-0000-0000-0000-000000000006', 'Amanda Thomas', 'amanda.thomas@email.com', 5, 
...
('att007-0000-0000-0000-000000000007', 'Christopher Lee', 'christopher.lee@email.com', 5, 
...
('att008-0000-0000-0000-000000000008', 'Patricia White', 'patricia.white@email.com', 5, 
...
('att009-0000-0000-0000-000000000009', 'Richard Harris', 'richard.harris@email.com', 4, 
...
('att010-0000-0000-0000-000000000010', 'Susan Clark', 'susan.clark@email.com', 5, 
...
('att001-0000-0000-0000-000000000001', (SELECT id FROM practice_areas WHERE slug = 'personal-injury'), 
...
('att002-0000-0000-0000-000000000002', (SELECT id FROM practice_areas WHERE slug = 'family-law'), 
...
('att003-0000-0000-0000-000000000003', (SELECT id FROM practice_areas WHERE slug = 'criminal-defense'), 
...
('att004-0000-0000-0000-000000000004', (SELECT id FROM practice_areas WHERE slug = 'business-law'), 
...
('att005-0000-0000-0000-000000000005', (SELECT id FROM practice_areas WHERE slug = 'real-estate-law'), 
...
('att006-0000-0000-0000-000000000006', (SELECT id FROM practice_areas WHERE slug = 'immigration-law'), 
...
('att007-0000-0000-0000-000000000007', (SELECT id FROM practice_areas WHERE slug = 'employment-law'), 
...
('att008-0000-0000-0000-000000000008', (SELECT id FROM practice_areas WHERE slug = 'estate-planning'), 
...
('att009-0000-0000-0000-000000000009', (SELECT id FROM practice_areas WHERE slug = 'bankruptcy'), 
...
('att010-0000-0000-0000-000000000010', (SELECT id FROM practice_areas WHERE slug = 'dui-defense'), 
...
-- Update attorney statistics (this would normally be calculated, but for testing we'll set some values)
UPDATE public.attorneys SET 
  average_rating = 4.8,
  review_count = 2
WHERE id = 'att001-0000-0000-0000-000000000001';

UPDATE public.attorneys SET 
  average_rating = 4.5,
  review_count = 2
WHERE id = 'att002-0000-0000-0000-000000000002';

UPDATE public.attorneys SET 
  average_rating = 5.0,
  review_count = 1
WHERE id = 'att003-0000-0000-0000-000000000003';

UPDATE public.attorneys SET 
  average_rating = 5.0,
  review_count = 1
WHERE id = 'att004-0000-0000-0000-000000000004';

UPDATE public.attorneys SET 
  average_rating = 4.0,
  review_count = 1
WHERE id = 'att005-0000-0000-0000-000000000005';

UPDATE public.attorneys SET 
  average_rating = 5.0,
  review_count = 1
WHERE id = 'att006-0000-0000-0000-000000000006';

UPDATE public.attorneys SET 
  average_rating = 5.0,
  review_count = 1
WHERE id = 'att007-0000-0000-0000-000000000007';

UPDATE public.attorneys SET 
  average_rating = 5.0,
  review_count = 1
WHERE id = 'att008-0000-0000-0000-000000000008';

UPDATE public.attorneys SET 
  average_rating = 4.0,
  review_count = 1
WHERE id = 'att009-0000-0000-0000-000000000009';

UPDATE public.attorneys SET 
  average_rating = 5.0,
  review_count = 1
WHERE id = 'att010-0000-0000-0000-000000000010';

-- Add some additional practice areas for more variety
INSERT INTO public.attorney_practice_areas (attorney_id, practice_area_id, is_primary, created_at) VALUES
-- Add more secondary practice areas
('att001-0000-0000-0000-000000000001', (SELECT id FROM practice_areas WHERE slug = 'employment-law'), false, NOW()),
('att002-0000-0000-0000-000000000002', (SELECT id FROM practice_areas WHERE slug = 'personal-injury'), false, NOW()),
('att003-0000-0000-0000-000000000003', (SELECT id FROM practice_areas WHERE slug = 'personal-injury'), false, NOW()),
('att004-0000-0000-0000-000000000004', (SELECT id FROM practice_areas WHERE slug = 'real-estate-law'), false, NOW()),
('att005-0000-0000-0000-000000000005', (SELECT id FROM practice_areas WHERE slug = 'estate-planning'), false, NOW());
