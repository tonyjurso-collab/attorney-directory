...
interface PracticeAreaOnlyContentProps {
  practiceArea: string;
}

export function PracticeAreaOnlyContent({ practiceArea }: PracticeAreaOnlyContentProps) {
      ...
      case 'personal injury':
        return {
          whyChoose: {
            ...
            description: 'Our network of personal injury lawyers has a proven track record of securing maximum compensation for accident victims.',
            points: [
      ...
      case 'family law':
        return {
          whyChoose: {
            ...
            description: 'Our compassionate family law attorneys understand the emotional challenges of family legal matters.',
            points: [
      ...
      default:
        return {
          whyChoose: {
            ...
            description: `Our network of ${area.toLowerCase()} attorneys provides expert legal representation with personalized service.`,
            points: [
