...
interface PracticeAreaHeroSectionProps {
  practiceArea: string;
  category?: string;
  subcategory?: string;
}

export function PracticeAreaHeroSection({ practiceArea, category, subcategory }: PracticeAreaHeroSectionProps) {
              ...
              <div className="text-center space-y-6">
                ...
                <div className="bg-white rounded-lg shadow-xl">
                  <ChatWidget 
                    ...
                    welcomeMessage={`Hi! I'm here to help you find a ${practiceArea.toLowerCase()} attorney. What's your legal situation?`}
                  />
                </div>
